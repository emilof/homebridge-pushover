...
module.exports = class Switch extends Accessory {
    ...
    constructor(platform, config) {
        ...
        var {type, name, message, type, title, expire = 3600, retry = 60, priority, sound, model = 'Pushover Message', manufacturer = 'Pushover', serialNumber = '1.0'} = config;
            ...
            if (type == 'masterSwitch') {
                ...
                if (value) {
                    ...
                    if (this.platform.enabled || priority > 0) {
                        platform.pushover({priority:priority, message:message, title:title, retry:retry, expire:expire, sound:sound}).then(() => {
